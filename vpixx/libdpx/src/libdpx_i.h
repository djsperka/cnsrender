...
#define DPXREG_DPID					0x00			// DATAPixx Identification register, read-only.
    ...
    #define DPXREG_DPID_TP				0x5450		// = ASCII "TP" for TRACKPixx eye tracker camera with embedded DATAPixx
...
#define DPXREG_OPTIONS				0x02			// Hardware option summary, read-only.
	...
	//			0x34: VIEWPixx/3D Lite (VPX-2004A)
	//			0x35: VIEWPixx/3D Full (VPX-2005C)
	//			0x36: VIEWPixx EEG (VPX-2006A)
    //			0x38: PROPixxCtrl Lite
    //			0x39: PROPixxCtrl Full
    ...
    #define DPXREG_OPTIONS_RAM_512M		0x0005
	#define DPXREG_OPTIONS_RAM_1024M	0x0006
	#define DPXREG_OPTIONS_RAM_2048M	0x0007
...
//	BITS
//	2		DPXREG_DOUT_CTRL_PIXEL_MODE (VIEWPixx only)
...
#define DPXREG_VID_CTRL3             0x1A4
	...
	//  Bit 9:4	Phase Test Speed (PP Only)
	//  Bit   3	TX DVI Passthru disable (PPC Only)
	//  Bit   2 Phase Test Enable (PP Only)
	...
	#define DPXREG_VID_CTRL3_PHASE_TEST_SPEED   0x03F0
	#define DPXREG_VID_CTRL3_TX_DVI_NO_PASSTHRU	0x0008
	#define DPXREG_VID_CTRL3_PHASE_TEST_EN      0x0004
...
#define PPXREG_TSCOPE_CSR               0x12E
    //  Bit   5	Tachistoscope preparation phase acknowledge (RO)
    //  Bit   4	Tachistoscope preparation phase request
    //  Bit   0	Tachistoscope enable
...
#define PPXREG_0x158                    0x158
#define PPXREG_0x15A                    0x15A
...
#define PPXREG_VID_INTENSITY        0x16A
#define PPXREG_VID_SEQ_PERIOD       0x16C
...
//  0x0060 - 0x0067                     MAXD65/64
//  0x0070 - 0x0077                     MAXD65/128
...
#define SEQ_8BIT_GREY_720HZ_KOREA_c		10
...
#define CONFIG_BUFFER_SIZE  0x00600000 // temp for TRACKPixx Preleminary test
...
#define DPX_DEVSEL_DPX              1
#define DPX_DEVSEL_VPX              2
#define DPX_DEVSEL_PPC              3
#define DPX_DEVSEL_PPX              4
#define DPX_DEVSEL_DP2              5
#define DPX_DEVSEL_TPX              6
#define DPX_DEVSEL_LAST_DEVICE      6
...
#define DPX_DEVSEL_PPC_VPX_DPX_TPX  -4      // I/O subsystems, video line buffer
#define DPX_DEVSEL_PPC_VPX_TPX      -5      // on-board power supply monitoring, videoscope
...
// PROPixxHot spot correction Rev >= 16 only
...
#define DPxIsS3Arch() (DPxIsViewpixx() || DPxIsPropixx() || DPxIsPropixxCtrl() || DPxIsDatapixx2() || DPxIsTrackpixx())		// Stratix III standardized architecture used after DATAPixx
